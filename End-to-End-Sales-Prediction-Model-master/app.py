...
def predict():
    ...
    model_path=r'C:\Users\Administrator\OneDrive\Desktop\models\End-to-End-Sales-Prediction-Model-master\models\cat_model.sav'
...
def visualize():
    ...
    forecastCAT=pd.read_csv(r'C:\Users\Administrator\OneDrive\Desktop\models\End-to-End-Sales-Prediction-Model-master\datasets\file.csv')
