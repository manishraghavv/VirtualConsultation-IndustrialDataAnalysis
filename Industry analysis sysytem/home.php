    ...
    <header class="navbar-section">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><i class="bi bi-chat"></i> </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12 text-content">
                    <h1>Industrial Data Analysis</h1>
                    ...
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Address</h3>
                                <p>CSIT Block Akgec,<br>Ghaziabad, 201010</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Call Us</h3>
                                <p>+91 9717102203<br>+91 9772474874</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Email Us</h3>
                                <p>manishraghav@gmail.com<br>raghavmanish@gmail.com</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
